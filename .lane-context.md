...
- `rolle` · lookup · Rolle · required! · options: reinigung | vermietung
- `telefon` · tel · Telefon
- `email` · email · E-Mail
- `status` · lookup · Status · required! · options: aktiv | inaktiv
Input shapes: choice `rolle` (ChoiceGroup); choice `status` (ChoiceGroup)

### `wohnungen` — Wohnungen (type `Wohnungen`, one record: `WohnungenEntry`)
Display fields: `name`
- `name` · text · Name der Wohnung · required! · maxLength 4000
- `beschreibung` · textarea · Beschreibung
- `stockwerk` · number · Stockwerk
- `schlafplaetze` · number · Schlafplätze · required!
- `quadratmeter` · number · Quadratmeter
- `grundpreis_pro_nacht` · number · Grundpreis pro Nacht (€) · required! · currency
- `endreinigung_preis` · number · Endreinigung (€) · currency
- `ausstattung` · multilookup · Ausstattung · options: seeblick | kueche | wlan | parkplatz | haustiere_erlaubt | balkon
- `foto` · file · Foto · read-only
- `status` · lookup · Status · required! · options: verfuegbar | gesperrt
Input shapes: choice `status` (ChoiceGroup); stock `stockwerk` (BudgetTracker)

### `gaeste` — Gäste (type `Gaeste`, one record: `GaesteEntry`)
Display fields: `vorname`, `nachname`
- `vorname` · text · Vorname · required! · maxLength 4000
- `nachname` · text · Nachname · required! · maxLength 4000
- `email` · email · E-Mail
...
- `land` · text · Land · maxLength 4000
- `notizen` · textarea · Notizen

### `buchungen` — Buchungen (type `Buchungen`, one record: `BuchungenEntry`)
Display fields: `buchungsnummer`
- `buchungsnummer` · text · Buchungsnummer · required! · maxLength 4000
- `wohnung` · record · Wohnung · required! · → `wohnungen`
- `gast` · record · Gast · required! · → `gaeste`
- `anreise` · date · Anreise · required!
- `abreise` · date · Abreise · required!
- `anzahl_personen` · number · Anzahl Personen · required!
- `status` · lookup · Status · required! · options: anfrage | bestaetigt | eingecheckt | ausgecheckt | storniert
- `gesamtpreis` · number · Gesamtpreis (€) · currency
- `anzahlung_erhalten` · bool · Anzahlung erhalten
- `notizen` · textarea · Notizen
Input shapes: range `anreise`+`abreise` (AvailabilityRangePicker); choice `status` (ChoiceGroup)

### `reinigungen` — Reinigungen (type `Reinigungen`, one record: `ReinigungenEntry`)
Display fields: `bemerkungen`
- `wohnung` · record · Wohnung · required! · → `wohnungen`
- `buchung` · record · Buchung · → `buchungen`
- `datum` · date · Reinigungsdatum · required!
- `reinigungskraft` · record · Reinigungskraft · required! · → `mitarbeiter`
- `status` · lookup · Status · required! · options: offen | erledigt
- `bemerkungen` · textarea · Bemerkungen
