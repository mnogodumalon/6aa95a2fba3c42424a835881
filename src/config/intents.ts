...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in 4 Schritten anlegen: Wohnung, Reisedaten, Gast, Bestätigung' },
  { path: '/intents/buchung-verwalten', label: { de: 'Buchung verwalten', en: 'Manage booking' }, icon: IconClipboardCheck, description: 'Status einer Buchung ändern und optional Reinigung anlegen' },
  { path: '/intents/reinigung-abhaken', label: { de: 'Reinigung abhaken', en: 'Mark cleaning done' }, icon: IconSparkles, description: 'Reinigungskraft hakt eine erledigte Reinigung ab und fügt Bemerkungen hinzu' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-15T14:46:26+00:00';
