...
const IntentBuchungStatusPage = lazy(() => import('@/pages/intents/BuchungStatusPage'));
const IntentReinigungAbschliessenPage = lazy(() => import('@/pages/intents/ReinigungAbschliessenPage'));
// </custom:imports>
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/buchung-status" element={<Suspense fallback={<DashboardSkeleton />}><IntentBuchungStatusPage /></Suspense>} />
                <Route path="intents/reinigung-abschliessen" element={<Suspense fallback={<DashboardSkeleton />}><IntentReinigungAbschliessenPage /></Suspense>} />
                {/* </custom:routes> */}
