...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  wohnungen: { name: "Bitte den Namen der Wohnung eingeben.", schlafplaetze: "Bitte die Anzahl der Schlafplätze eingeben.", grundpreis_pro_nacht: "Bitte den Grundpreis pro Nacht eingeben.", status: "Bitte den Status auswählen." },
  gaeste: { vorname: "Bitte den Vornamen eingeben.", nachname: "Bitte den Nachnamen eingeben." },
  buchungen: { buchungsnummer: "Bitte eine Buchungsnummer eingeben.", wohnung: "Bitte eine Wohnung auswählen.", gast: "Bitte einen Gast auswählen.", anreise: "Bitte das Anreisedatum wählen.", abreise: "Bitte das Abreisedatum wählen.", anzahl_personen: "Bitte die Personenanzahl eingeben.", status: "Bitte den Buchungsstatus auswählen." },
  reinigungen: { wohnung: "Bitte eine Wohnung auswählen.", datum: "Bitte das Reinigungsdatum wählen.", reinigungskraft: "Bitte eine Reinigungskraft auswählen.", status: "Bitte den Status auswählen." },
  // </custom:messages>
};
